...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    private void uploadQuestion(){
        ...
        FirebaseDatabase.getInstance().getReference()
                .child("SETS").child(categoryName).child("questions").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    QuestionModel questionModel = new QuestionModel(id , Objects.requireNonNull(map.get("question")).toString() ,
                            ...
                            Objects.requireNonNull(map.get("optionD")).toString(), Objects.requireNonNull(map.get("correctAnswer")).toString(), (int) map.get("setNo"));
